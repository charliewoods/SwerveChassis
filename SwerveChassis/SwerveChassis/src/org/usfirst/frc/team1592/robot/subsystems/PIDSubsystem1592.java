 ...
 * which uses a single {@link PIDController1592} almost constantly (for instance, an
 * elevator which attempts to stay at a constant height).
 *
 * <p>
 * It provides some convenience methods to run an internal {@link PIDController1592}
 * . It also allows access to the internal {@link PIDController1592} in order to
...
public abstract class PIDSubsystem1592 extends Subsystem implements Sendable {
  ...
  /**
   * Instantiates a {@link PIDSubsystem1592} that will use the given p, i and d
   * values.
   *$
   * @param name the name
  ...
  /**
   * Returns the {@link PIDController1592} used by this {@link PIDSubsystem1592}. Use
   * this if you would like to fine tune the pid loop.
   *
   * @return the {@link PIDController1592} used by this {@link PIDSubsystem1592}
   */
   ...
   * {@link PIDSubsystem1592#setInputRange(double, double) setInputRange(...)} was
  ...
  public void setPercentTolerance(double p) {
	 ...
	 * @param minimumInput minimum input allowed by controller
	 * @param maximumInput maximum input allowed by controller
	 */
   ...
   *
   * <p>
   * All subclasses of {@link PIDSubsystem1592} must override this method.
   * </p>
   *
